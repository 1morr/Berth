...
| M2 | `.scratch/m2/issues/` | plan §11.3；brief §9、§11、§19 | **2026-09-22 拆票前的文件收尾完成**：plan §11.3 已重寫（九題設計決定、建議票序、遺留清單歸屬），拆票時以它為底 |
| M3 | `.scratch/m3/issues/` | plan §11.4；brief §15 | 先抓 Mikan 與 Nyaa 的 RSS fixture |
| M4 | `.scratch/m4/issues/` | plan §11.5；brief §6.10 | |
| M5 | `.scratch/m5/issues/` | plan §11.6；brief §14 | 通知（2026-09-22 加入） |
| M6 | `.scratch/m6/issues/` | plan §11.7；brief §14、§6.10 | AI 助理（2026-09-22 加入） |
| M7 | `.scratch/m7/issues/` | plan §11.8；brief §14、§16.2 | 外部對話（2026-09-22 加入） |
