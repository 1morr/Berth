...
const zhHant = {
  ...
  inventory: {
    title: '媒體庫',
    // 切換列的名字。Route 是 CONTEXT.md 的詞，兩個語言照用。
    routes: 'Route',
    titles_one: '{{count}} 部',
    titles_other: '{{count}} 部',
    disabled: '停用',
    filters: '篩選',
    filter: {
      all: '全部',
    ...
    empty: {
      noRoutes: '還沒有任何 Route。沒有它，下載完了沒有地方可以入庫，這一頁也沒有東西可以列。',
      toSetup: '到設定精靈建 Route',
      askAdmin: '請管理員建一條 Route。',
      route: '「{{route}}」還沒有任何作品。到探索頁找一部，搜 torrent 時「入庫到」選它。',
      toDiscover: '回探索頁',
      review: '沒有待審的作品。',
      unmatched: '沒有 Unmatched 的作品。',
      showAll: '顯示全部',
      unknown: '沒有叫「{{slug}}」的 Route。',
      toFirst: '看「{{route}}」',
    },
...
const en: Translations<typeof zhHant> = {
  ...
  inventory: {
    ...
    empty: {
      noRoutes:
        'No routes yet. Without one a finished download has nowhere to land, and this page has nothing to list.',
      toSetup: 'Create a route in the setup wizard',
      askAdmin: 'Ask an administrator to create a route.',
      route:
        '“{{route}}” has no titles yet. Find one on Discover, and pick this route under “Import into” when you search torrents.',
      toDiscover: 'Back to Discover',
      review: 'Nothing is waiting for review.',
      unmatched: 'Nothing has unmatched files.',
      showAll: 'Show all',
      unknown: 'There is no route called “{{slug}}”.',
      toFirst: 'Open “{{route}}”',
    },
