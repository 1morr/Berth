...
export interface components {
    schemas: {
        ...
        /**
         * PlanEditedOut
         * @description 改完的整份。帶了 `apply_to_series` 時多一格 `corrected`：Series 現在的值，與其餘的集數
         *     怎麼了。
         */
        PlanEditedOut: {
            /** Id */
         ...
         * @enum {string}
         */
        ReviewReason: "low_confidence" | "medium_not_allowed" | "nothing_to_import" | "target_exists" | "audit_undone" | "air_date_conflict" | "runtime_conflict";
        /**
         * ReviewRefusal
